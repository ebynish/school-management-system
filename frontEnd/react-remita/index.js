...
var RemitaPayment = /*#__PURE__*/ function (_Component) {
    ...
    _createClass(RemitaPayment, [{
        ...
        value: function startPayment() {
            console.log(this.props.remitaData, "data");
            var _this$props$remitaDat = this.props.remitaData,
                ...
                channel = _this$props$remitaDat.channel,
                narration = _this$props$remitaDat.narration,
                processRrr = _this$props$remitaDat.processRrr,
                rrr = _this$props$remitaDat.rrr,
                extendedData = _this$props$remitaDat.extendedData,
                onError = _this$props$remitaDat.onError;
                console.log(processRrr, extendedData)
